    ...
    <div id="tableau">
        <table class="table table-bordered table-striped text-center">
            ...
            <tr class="trInvisible">
                ...
                foreach ($coursListSansSae as $cours) {
                    echo "<th>{$cours['nom_cours']}</th>";
                }

                echo "<th colspan='" . count($coursListSae) . "'>SAE</th>";
                ?>
                <td class="tdInvisible"></td>
            </tr>
            <tr class="trInvisible">
            ...
            <tr class="trInvisible">
                ...
                <?php
                foreach ($coursList as $cours) {
                    echo "<td style='background-color: #2e86c1 !important; border-color: #2e86c1'>".$cours['code_cours']."</td>";
                }
                ?>
                <td class="tdInvisible"></td>
            </tr>
