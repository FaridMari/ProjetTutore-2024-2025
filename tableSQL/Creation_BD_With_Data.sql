...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 09 jan. 2025 à 08:37
...
INSERT INTO `contraintes` (`id_contrainte`, `id_utilisateur`, `jour`, `heure_debut`, `heure_fin`, `creneau_preference`, `cours_samedi`) VALUES
                                                                                                                                            (5, 16, 'lundi', 8, 10, NULL, NULL),
                                                                                                                                            (6, 16, 'lundi', 8, 10, NULL, NULL);
...
INSERT INTO `enseignants` (`id_enseignant`, `id_utilisateur`, `heures_affectees`, `statut`, `total_hetd`) VALUES
                                                                                                              (1, 2, 0, 'vacataire', 0),
                                                                                                              (55, 1, 0, 'vacataire', 0),
                                                                                                              (58, 13, 0, 'enseignant-chercheur', 0),
                                                                                                              (61, 16, 0, 'enseignant-chercheur', 0);
...
INSERT INTO `utilisateurs` (`id_utilisateur`, `nom`, `prenom`, `email`, `mot_de_passe`, `role`, `statut`, `nombre_heures`, `reset_token`, `reset_token_expiration`) VALUES
                                                                                                                                                                        (1, 'test2', 'gestionnaire', 'test2@gmail.com', 'azertyuiop', 'gestionnaire', NULL, NULL, NULL, NULL),
                                                                                                                                                                        (2, 'test', 'enseignant', 'test@gmail.com', 'azertyuiop', 'enseignant', NULL, NULL, NULL, NULL),
                                                                                                                                                                        (13, 'poubelle', 'poubelle', 'pb@gmail.com', '$2y$10$qt14uC3CRcQcfe38N4aIcOx4S7KiUVUrTYcsAhewj6Ry6ANElmnfq', 'enseignant', 'enseignant-chercheur', 0, NULL, NULL),
                                                                                                                                                                        (16, 'a', 'b', 'a@gmail.com', '$2y$10$AnSHQ8TQOKUJaOYyz6tRYekvUYQJ/LO.dNqGBXf31JkyTUqf9jLpa', 'enseignant', 'enseignant-chercheur', 0, NULL, NULL);
...
--
ALTER TABLE `contraintes`
    MODIFY `id_contrainte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `details_cours`
    MODIFY `id_ressource` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `enseignants`
--
ALTER TABLE `enseignants`
    MODIFY `id_enseignant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `repartition_heures`
    MODIFY `id_repartition` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2046;
...
--
ALTER TABLE `voeux`
    MODIFY `id_voeu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
